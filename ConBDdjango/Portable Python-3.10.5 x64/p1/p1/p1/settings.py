...
SECRET_KEY = 'django-insecure-&805w$n9vu(_a)7hk$g(asr0tlh(y$ok_zo+)%!+2i^7@p(g^t'
...
AUTH_USER_MODEL = 'a1.CustomUser'

import os
# Defina o caminho absoluto para a pasta 'media'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Defina a URL para acessar os arquivos de mídia
MEDIA_URL = '/media/'